...
//        // Query 3: Find all traders from Cambridge and sort them by name.
        // My answer
//        transactions.stream().filter(t->"Cambridge".equals(t.getTrader().getCity())).map(Transaction::getTrader).distinct().sorted(comparing(Trader::getName)).forEach(System.out::println);
//        // official answer
//        List<Trader> traders =
//                transactions.stream()
